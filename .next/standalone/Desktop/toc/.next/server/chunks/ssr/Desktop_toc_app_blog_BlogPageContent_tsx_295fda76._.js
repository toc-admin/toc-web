module.exports=[64233,a=>{"use strict";var b=a.i(71932),c=a.i(90340),d=a.i(80826),e=a.i(24720),f=a.i(51068),g=a.i(97932),h=a.i(78131);let i=[{id:1,date:"25 February 2025",slug:"the-future-of-work-why-integrating-coworking-spaces-into-office-buildings-is-a-game-changer",name:"The Future of Work: Why Integrating Coworking Spaces into Office Buildings is a Game Changer",shortDescription:"How coworking spaces in office buildings can enhance collaboration, flexibility, and cost-efficiency.",longDescription:`
    ...
    `,image:"/images/future-of-office.webp"},{id:2,date:"01 July 2025",slug:"understanding-the-shift-in-office-leasing-trends",name:"Understanding the Shift in Office Leasing Trends: What It Means for Landlords",shortDescription:"These shifts aren't limited to coworking alone. Conventional leases, which used to lock tenants in for 5+ years, are also being affected.",longDescription:`
    ...
    `,image:"/images/office-trends.jpg"},{id:3,date:"18 August 2025",slug:"five-key-considerations-when-creating-productive-and-flexible-office-space",name:"5 Key Considerations When Creating Productive and Flexible Office Space",shortDescription:"When creating productive and flexible office space, there are five major areas that must be carefully considered: people, culture, space, technical requirements, and time frame.",longDescription:`
    ...
    `,image:"/images/blog-three.jpeg"},{id:4,date:"25 November 2025",slug:"tackling-noise-in-open-plan-offices-with-purpose-built-phone-booths",name:"Tackling Noise in Open-Plan Offices: The Smart Solution with Phone Booths",shortDescription:"How purpose-built phone booths can improve focus, comfort, and productivity in open-plan offices.",longDescription:`
    ...
    `,image:"/images/blogFour.jpg"}];function j(){let a=(0,c.useRef)(null),j=(0,c.useRef)(null),k=(0,e.useInView)(a,{once:!0,amount:.5}),l=(0,e.useInView)(j,{once:!0,amount:.1}),m=i[0];return(0,b.jsxs)("div",{className:"pt-32 md:pt-44",children:[(0,b.jsxs)("div",{ref:a,className:"relative px-4 sm:px-6 md:px-12 lg:px-24 xl:px-44 py-24 md:py-32 overflow-hidden bg-gradient-to-br from-white via-red-50/20 to-white",children:[(0,b.jsx)("div",{className:"absolute inset-0 opacity-[0.03]",children:(0,b.jsx)("div",{className:"absolute inset-0",style:{backgroundImage:`
                linear-gradient(to right, #7C2D3A 1px, transparent 1px),
                linear-gradient(to bottom, #7C2D3A 1px, transparent 1px)
              `,backgroundSize:"60px 60px"}})}),(0,b.jsxs)("div",{className:"relative z-10",children:[(0,b.jsxs)("div",{className:"flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8 mb-16",children:[(0,b.jsxs)(d.motion.div,{initial:{opacity:0,y:30},animate:k?{opacity:1,y:0}:{},transition:{duration:.8,ease:[.22,1,.36,1]},className:"flex-1",children:[(0,b.jsx)(d.motion.span,{initial:{opacity:0,y:20},animate:k?{opacity:1,y:0}:{},transition:{duration:.6,ease:[.22,1,.36,1]},className:"text-sm font-bold uppercase tracking-widest text-red-800",children:"Our Blog"}),(0,b.jsxs)("h1",{className:"text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[0.95] tracking-tight mt-6 mb-8",children:["Insights &",(0,b.jsx)("br",{}),(0,b.jsx)("span",{className:"bg-gradient-to-r from-red-900 via-red-700 to-red-600 bg-clip-text text-transparent",children:"Market News"})]}),(0,b.jsx)(d.motion.div,{initial:{scaleX:0},animate:k?{scaleX:1}:{},transition:{duration:1,ease:[.22,1,.36,1],delay:.3},className:"h-2 bg-gradient-to-r from-red-900 to-red-700 w-32 origin-left"})]}),(0,b.jsx)(d.motion.p,{initial:{opacity:0,x:30},animate:k?{opacity:1,x:0}:{},transition:{duration:.7,ease:[.22,1,.36,1],delay:.4},className:"text-base md:text-lg leading-relaxed text-gray-700 max-w-xl",children:"Stay informed with expert insights on office trends, productivity tips, and the future of workspaces. Discover how we're shaping the industry."})]}),m&&(0,b.jsxs)(d.motion.div,{initial:{opacity:0,y:50},animate:k?{opacity:1,y:0}:{},transition:{duration:.8,ease:[.22,1,.36,1],delay:.5},className:"relative group",children:[(0,b.jsx)("div",{className:"absolute -top-4 -left-4 bg-gradient-to-br from-red-900 to-red-700 text-white px-6 py-2 text-sm font-bold uppercase tracking-wider z-20",children:"Featured"}),(0,b.jsx)("div",{className:"bg-white border border-red-100 overflow-hidden hover:shadow-2xl transition-shadow duration-500",children:(0,b.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-2",children:[(0,b.jsxs)("div",{className:"relative h-[400px] lg:h-[500px] overflow-hidden",children:[(0,b.jsx)(d.motion.div,{whileHover:{scale:1.05},transition:{duration:.6,ease:[.22,1,.36,1]},className:"w-full h-full relative",children:(0,b.jsx)(g.default,{src:m.image,alt:m.name,fill:!0,className:"object-cover",sizes:"(max-width: 1024px) 100vw, 50vw",priority:!0})}),(0,b.jsx)("div",{className:"absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"})]}),(0,b.jsxs)("div",{className:"p-8 md:p-12 flex flex-col justify-center",children:[(0,b.jsx)("span",{className:"text-sm font-bold uppercase tracking-widest text-red-800 mb-4",children:"Latest Article"}),(0,b.jsx)("h2",{className:"text-3xl md:text-4xl font-bold leading-tight mb-6 group-hover:text-red-900 transition-colors duration-300",children:m.name}),(0,b.jsx)("p",{className:"text-base md:text-lg leading-relaxed text-gray-700 mb-8",children:m.shortDescription}),(0,b.jsxs)(f.default,{href:`/blog/${m.slug}`,className:"inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-red-900 to-red-700 text-white font-semibold uppercase tracking-wider hover:from-red-800 hover:to-red-600 transition-all duration-300 group/btn w-fit",children:["Read Article",(0,b.jsx)("svg",{className:"w-5 h-5 group-hover/btn:translate-x-1 transition-transform duration-300",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M17 8l4 4m0 0l-4 4m4-4H3"})})]})]})]})})]})]})]}),(0,b.jsxs)("div",{ref:j,className:"px-4 sm:px-6 md:px-12 lg:px-24 xl:px-44 py-24 md:py-32 bg-white",children:[(0,b.jsxs)(d.motion.div,{initial:{opacity:0,y:20},animate:l?{opacity:1,y:0}:{},transition:{duration:.7,ease:[.22,1,.36,1]},className:"flex items-center justify-between mb-12",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("h2",{className:"text-3xl md:text-4xl lg:text-5xl font-bold mb-4",children:"All Articles"}),(0,b.jsx)("div",{className:"h-1 bg-gradient-to-r from-red-900 to-red-700 w-24"})]}),(0,b.jsxs)("div",{className:"text-right",children:[(0,b.jsxs)("p",{className:"text-lg font-semibold text-gray-900",children:[i.length," ",1===i.length?"Article":"Articles"]}),(0,b.jsx)("p",{className:"text-sm text-gray-600",children:"Updated regularly"})]})]}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10",children:i.map((a,c)=>(0,b.jsx)(d.motion.div,{initial:{opacity:0,y:50},animate:l?{opacity:1,y:0}:{},transition:{duration:.7,ease:[.22,1,.36,1],delay:.1*c},children:(0,b.jsx)(h.default,{image:a.image,name:a.name,shortDescription:a.shortDescription,slug:a.slug})},a.id))}),0===i.length&&(0,b.jsx)(d.motion.div,{initial:{opacity:0},animate:l?{opacity:1}:{},transition:{duration:.7,ease:[.22,1,.36,1]},className:"text-center py-24",children:(0,b.jsxs)("div",{className:"max-w-md mx-auto",children:[(0,b.jsx)("div",{className:"w-24 h-24 bg-gradient-to-br from-red-900 to-red-700 rounded-full flex items-center justify-center mx-auto mb-6",children:(0,b.jsx)("svg",{className:"w-12 h-12 text-white",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"})})}),(0,b.jsx)("h3",{className:"text-2xl font-bold mb-4",children:"No Articles Yet"}),(0,b.jsx)("p",{className:"text-gray-600",children:"Check back soon for insights and updates from The Office Company."})]})})]}),(0,b.jsx)("div",{className:"px-4 sm:px-6 md:px-12 lg:px-24 xl:px-44 py-24 md:py-32 bg-gradient-to-br from-gray-900 via-red-950 to-black",children:(0,b.jsxs)(d.motion.div,{initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.5},transition:{duration:.8,ease:[.22,1,.36,1]},className:"max-w-4xl mx-auto text-center text-white",children:[(0,b.jsx)("span",{className:"text-sm font-bold uppercase tracking-widest text-red-300 mb-4 block",children:"Stay Updated"}),(0,b.jsx)("h2",{className:"text-3xl md:text-4xl lg:text-5xl font-bold mb-6",children:"Subscribe to Our Newsletter"}),(0,b.jsx)("div",{className:"h-1 bg-gradient-to-r from-red-500 to-red-300 w-24 mx-auto mb-8"}),(0,b.jsx)("p",{className:"text-lg text-white/80 mb-10 max-w-2xl mx-auto",children:"Get the latest insights, trends, and news delivered straight to your inbox. Join our community of workspace innovators."}),(0,b.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 max-w-xl mx-auto",children:[(0,b.jsx)("input",{type:"email",placeholder:"Enter your email",className:"flex-1 px-6 py-4 bg-white/10 border border-white/20 text-white placeholder:text-white/60 focus:border-red-500 focus:ring-2 focus:ring-red-500/50 outline-none transition-all duration-300"}),(0,b.jsx)("button",{className:"px-8 py-4 bg-gradient-to-r from-red-900 to-red-700 text-white font-semibold uppercase tracking-wider hover:from-red-800 hover:to-red-600 transition-all duration-300 whitespace-nowrap",children:"Subscribe"})]})]})})]})}a.s(["default",()=>j],64233)}];

//# sourceMappingURL=Desktop_toc_app_blog_BlogPageContent_tsx_295fda76._.js.map