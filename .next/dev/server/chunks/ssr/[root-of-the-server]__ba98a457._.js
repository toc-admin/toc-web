...
"[project]/Desktop/toc/app/categories/[slug]/not-found.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/Desktop/toc/app/categories/[slug]/not-found.tsx [app-rsc] (ecmascript)"));
}),
...
async function getCategoryData(slug) {
    ...
    `, {
        count: 'exact'
    }).eq('category_id', categoryId).is('deleted_at', null).order('created_at', {
        ascending: false
    });
    // Get all available rooms for filtering
    const { data: availableRooms } = await supabase.from('rooms').select('id, name, slug').order('name');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba98a457._.js.map