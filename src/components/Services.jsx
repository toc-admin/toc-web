import serviceOne from "../assets/images/tocConsulting.webp";
import serviceTwo from "../assets/images/tocManagement.jpeg";
import serviceThree from "../assets/images/tocFurniture.webp";
  ...
  return (
    <motion.div
      ...
      transition={{ 
        duration: 0.6, 
        ease: "easeOut",
        delay: index * 0.15 // Reduced stagger delay
      }}
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-12 py-12 md:py-16">
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 md:w-2/5">
          ...
          <div className="relative w-64 h-64 md:w-40 md:h-40 overflow-hidden border-2 border-red-100 group-hover:border-red-700 transition-colors duration-300">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-br from-red-900/20 to-transparent group-hover:from-red-900/10 transition-all duration-500" />
          </div>
        </div>

        {/* Content - All elements animate together with parent */}
